...
Deploys the **Kopiur** Kopia-native Kubernetes backup operator: the controller, the admission webhook, the 7 `kopiur.home-operations.com/v1alpha1` CRDs, and the RBAC to run them. Implements [ADR-0003](../../../docs/adr/0003-kopiur-rust-operator.md).
