...
| `kopiur_snapshot_last_success_timestamp_seconds` | gauge       | `namespace`, `name`                        | Backup → Succeeded                                                                                                                                                                         |
| `kopiur_snapshot_consecutive_failures`           | gauge       | `namespace`, `name`                        | SnapshotPolicy reconcile (trailing Failed before the latest Succeeded)                                                                                                                       |
